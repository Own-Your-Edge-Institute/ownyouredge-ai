...
const CTASection = () => (
  <section className="py-32 lg:py-48 px-6 lg:px-12 relative" id="certify">
    <div className="max-w-[1400px] mx-auto">
      <div className="relative rounded-[2rem] overflow-hidden border border-border border-glow bg-secondary/30">
        ...
        <div className="relative z-10 p-10 lg:p-20 grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <motion.h2
              ...
              className="text-4xl lg:text-6xl font-serif leading-[1.05] mt-4 mb-6 text-foreground"
            >
              Ready to own
              <br />
          ...
          >
            <div className="relative">
              <div className="absolute -inset-20 rounded-full bg-primary/5 blur-[80px]" />
              <img src={certificateBadge} alt="Professional AI Certification" width={320} height={320} loading="lazy" className="relative" />
            </div>
          </motion.div>
        </div>
      </div>
